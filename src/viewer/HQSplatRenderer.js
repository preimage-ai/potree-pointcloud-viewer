...
export class HQSplatRenderer{
	...
	splitRender (params) {
		...
		{ // DEPTH PASS
			...
			viewer.pRenderer.render(viewer.scene2.scenePointCloud, camera, this.rtDepth, {
		...
		{ // ATTRIBUTE PASS
			...
			viewer.renderer.setRenderTarget(null);
			viewer.pRenderer.render(viewer.scene2.scenePointCloud, camera, this.rtAttribute, {
				clipSpheres: viewer.scene2.volumes.filter(v => (v instanceof SphereVolume)),
				//material: this.attributeMaterial,
				blendFunc: [gl.SRC_ALPHA, gl.ONE],
				//depthTest: false,
